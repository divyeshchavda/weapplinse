...
class _shop3State extends State<shop3> {
  ...
  Future<void> _shareImage() async {
    final String customFileName = "Pointed-collar top.jpg"; // Set custom name

    final ByteData bytes = await rootBundle.load('assets/UI/img_6.png');
    ...
    Share.shareXFiles([XFile(file.path)], text: "Pointed-collar top");
  }
  @override
