...
class _shop2State extends State<shop2> {
  ...
  Future<void> _shareImage() async {
    final String customFileName = "Winter Jacket.jpg"; // Set custom name

    final ByteData bytes = await rootBundle.load('assets/UI/img_5.png');
    ...
    Share.shareXFiles([XFile(file.path)], text: "Winter Jacket");
  }
  @override
