...
class shop4 extends StatefulWidget {
  const shop4({super.key});

  @override
  State<shop4> createState() => _shop4State();
}

class _shop4State extends State<shop4> {
  ...
  Future<void> _shareImage() async {
    final String customFileName = "White  T-shirt.jpg"; // Set custom name

    final ByteData bytes = await rootBundle.load('assets/UI/img_7.png');
    ...
    Share.shareXFiles([XFile(file.path)], text: "White  T-shirt");
  }
  @override
